 ...
 */
@Deprecated
public class DateDeprecated extends java.util.Date {
	...
	private DateDeprecated(long time) {
		super(time);
	}
	
	public static DateDeprecated valueOf(String dateTime) {
		try {
	 ...
	 * @return
	 */
	public static DateDeprecated valueOf(String dateTime, String pattern) {
		try {
			DateDeprecated date = input(dateTime, pattern);
	 ...
	 */
	private static DateDeprecated input(String dateTime, String pattern) throws ParseException {
		if (dateTime == null) {
			return null;
		}
		if (pattern == null) {
		...
		return new DateDeprecated(new SimpleDateFormat(pattern).parse(dateTime).getTime());
	}
	 ...
	 * @return
	 */
	private static String output(DateDeprecated date, String pattern) {
		if (date == null) {
			return "";
		}
		if (pattern == null) {
